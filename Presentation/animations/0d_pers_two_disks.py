...
import make_vector_fields as mvf
import viz

#### hardcoded info ####
home="/home/yoaveshel/Dropbox/Studies/Year 3/Period 4+5/Bachelor-Thesis/Presentation/animations"
...
# out_dir
out_path = os.path.join(home+'/figures', "0d_pers_two_sinks_{}".format(datetime_stamp))
os.mkdir(out_path)
